...
public class contract6_start : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        dialog[3] = new DialogData("집주인 남편되는 사람입니다. ", "대리인");
        dialog[4] = new DialogData("부인이 요즘 바빠서 저를 대신 보냈어요.", "대리인");
        dialog[5] = new DialogData("(남편이 대신 왔군..확인할게 많아지겠는걸)", "플레이어");
        dialog[6] = new DialogData("뭐부터 볼까?", "플레이어");
    }
